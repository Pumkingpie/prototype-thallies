...
const features = [
    ...
    'Customizable network to meet specific student needs.',
    ...
    'Students can stay connected on any device, at any time, and from anywhere within the property.'
];
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            <div className="flex-1 lg:hidden w-full">
                <div className="relative w-full h-64 rounded-lg overflow-hidden shadow-lg border-2 border-[#BF0603]">
                    <Image
                        src="/image/enterprise/Student-Housing/movie.webp"
                        alt="THALLIES Student Housing Wi-Fi"
                        fill
