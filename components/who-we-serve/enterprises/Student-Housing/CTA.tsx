            ...
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6">
                        Graduate Your Student Housing to THALLIES Fiber
                    </h2>
                    <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
                        Meet the high-speed demands of today&apos;s students with our specialized student housing solutions. Provide multi-gigabit internet, community-wide Wi-Fi, and entertainment options that attract and retain residents. Our student housing team is ready to upgrade your amenities.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                        ...
                        <OptimizedLink href="/contact" variant="button" size="lg" className="border-1 border-white text-white hover:bg-white hover:text-[#001427] px-8 py-3 text-lg">
                            Talk to Student Housing Expert
                        </OptimizedLink>
                    </div>
