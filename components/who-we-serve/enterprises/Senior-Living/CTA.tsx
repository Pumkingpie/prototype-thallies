            ...
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6">
                        Empower Senior Living with THALLIES Technology
                    </h2>
                    <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
                        Enhance the quality of life for senior residents with our specialized communication solutions. Provide reliable internet, interactive TV platforms, and voice services designed specifically for senior needs. Our senior living team is ready to enrich your community.
                    </p>
