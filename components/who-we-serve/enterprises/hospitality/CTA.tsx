            ...
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6">
                        Revolutionize Your Guest Experience with THALLIES
                    </h2>
                    <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
                        Elevate your hospitality services with our specialized fiber optic solutions. Provide guests with lightning-fast internet, seamless property-wide Wi-Fi, and premium entertainment options. Our hospitality team is ready to transform your guest experience.
                    </p>
