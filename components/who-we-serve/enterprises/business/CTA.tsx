            ...
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6">
                        Accelerate Your Business with THALLIES Fiber Solutions
                    </h2>
                    <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
                        Transform your business operations with our enterprise-grade fiber optic network. Get dedicated bandwidth, scalable solutions, and 24/7 support designed specifically for business needs. Our team is ready to help you optimize your connectivity infrastructure.
                    </p>
