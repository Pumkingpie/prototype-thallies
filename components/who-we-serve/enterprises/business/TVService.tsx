...
const features = [
    'High-definition (HD) picture quality for a superior viewing experience.',
    'Customizable channel packages to cater to specific business preferences.',
    'Interactive program guides for easy navigation and scheduling.',
    'Sports packages for dedicated sports enthusiasts and entertaining clients.',
    'Extensive channel lineup for staying updated with local and national news.',
    'A seamless and easy to navigate interface that is modern.',
    'Exclusive IPTV options for impressing clients and guests.',
    'Stay ahead of the curve with the ultimate choice for business entertainment.'
];
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            <div className="flex-1 lg:hidden w-full text-center">
                ...
                <h3 className="text-2xl font-semibold text-[#BF0603] mb-6">
                    Interactive, Informative, and Entertainment for Your Business
                </h3>
            </div>
            ...
            <div className="flex-1 lg:pr-8 w-full">
                <div className="text-left">
                    ...
                    <p className="text-xl text-[#708D81] mb-8 leading-relaxed">
                        Stay ahead of the curve with THALLIES TV, the ultimate choice for keeping your office in-sync with local and national news. Impress clients and guests with our exclusive IPTV options, providing an array of entertainment choices.
                    </p>
                    <div className="mb-8">
                        <Swiper
